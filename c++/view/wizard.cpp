...
wizard::wizard(QWidget *parent, Qt::WindowFlags flags): QWizard(parent,flags){
    ...
    QLabel* label1 = new QLabel( "La barra sfondo nero e testo bianco contiene il risultato dell'operazione che può essere salvato tramite l'icona alla sua destra (floppy). "
                                 ...
                                 "L'icona in alto a destra (ingranaggio) serve per accedere alle impostazioni che permettono di cambiare i colori del grafico e di modificare il range di disegno delle rette. \n\n"
                                 "INPUT: si possono inserire rette rigorosamente in questa forma 'ax + by + c = 0' (implicita e con '0' dopo l'uguale), punti nella forma (x;y) , quadrati e triangoli mettendo in sequenza i punti , es. (x1;y1)(x2;y2) ecc.. \n"
                                 "I coefficenti delle rette e i valori dei punti possono essere interi, razionali(es. 3/4 oppure 5/8) o double. Utilizzare il simbolo '.' per differenziare la parte intera dalla parte decimale invece del simbolo ',' (es. 3.67 e non 3,67). \n"

                                 "\nATTENZIONE: Gli slot vanno riempiti in ordine crescente. \nPurtroppo il coefficente della x o della y, nel caso razionale, è stato considerato"
                                 "(anche se in maniera matematicamente sbagliato) in questo modo: 6/7x rappresenta (6/7)x. "
